...
# Initialize the video llama Chat object with the appropriate device
...
with gr.Blocks() as demo:
    ...
    with gr.Column():
        gr.Examples(examples=[
            ["examples/dog.jpg", "Which breed is this dog? "],
            ["examples/JonSnow.jpg", "Who's the man on the right? "],
            ["examples/Statue_of_Liberty.jpg", "Can you tell me about this building? "],
        ], inputs=[image, text_input])

        gr.Examples(examples=[
            ["examples/skateboarding_dog.mp4", "What is the dog doing? "],
            ["examples/birthday.mp4", "What is the boy doing? "],
            ["examples/IronMan.mp4", "Is the guy in the video Iron Man? "],
